...
public class VideoCardAdapter extends RecyclerView.Adapter<VideoCardAdapter.ViewHolder> {
    ...
    public VideoCardAdapter(RealmList<RealmMovieData> videos,  int layout,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Objects.requireNonNull(videos.get(position)).setAdapterPosition(position);
        realm.commitTransaction();
        holder.bind(videos.get(position), itemClickListener, playClickListener, position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final RealmMovieData video,
                         ...
                         final OnPlayClickListener playlistener,
                         final int position) {
            int tries = 3;
            ...
            favorite.setBackgroundResource(video.isFavorite() ? R.drawable.ic_favorite_red_24dp : R.drawable.favicon);
            ...
            share.setOnClickListener(view -> {
                ...
                StringBuilder text = new StringBuilder(context.getResources().getText(R.string.hola).toString())
                        .append(" ")
                        .append(video.getTitle())
                        .append(context.getResources().getText(R.string.pelisandroid).toString())
                        .append(context.getResources().getText(R.string.installDeeplink).toString());
            ...
            poster.setOnClickListener(view -> {
                ...
                playlistener.onPlayClick(youtubePlayer,popupWindow);
            });
